...
`OPENAI_PARSE_MODEL=gpt-4o-mini` keeps routine query parsing off the stricter `gpt-4o` RPM budget, while `PUBLIC_REVIEW_CACHE_TTL_SECONDS=21600` reuses public-rating lookups for repeated searches.
